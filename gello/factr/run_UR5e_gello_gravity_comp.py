#!/usr/bin/env python3
"""
Direct UR5e_GELLO Gravity Compensation Script

This script directly launches the UR5e_GELLO in FACTR gravity compensation mode.
"""
...
def main():
    """Main function to run UR5e_GELLO gravity compensation"""

    print("=" * 60)
    print("UR5e_GELLO FACTR Gravity Compensation (Direct Physics)")
    print("=" * 60)
    ...
    urdf_path = str(
        Path(__file__).parent / "urdf" / "ur5e_active_gello" / "robot.urdf"
    )  # FIXED: Absolute path
    ...
    if not Path(urdf_path).exists():
        ...
        print("Make sure the ur5e_active_gello folder is in the correct location")
        sys.exit(1)
    ...
    try:
        ...
        print("=" * 60)
        print("The UR5e_GELLO should now feel lighter and more responsive.")
        print(
        ...
        try:
            driver.set_torque_mode(False)
            driver.close()
            print("UR5e_GELLO FACTR agent shutdown complete")
        except Exception as e:
